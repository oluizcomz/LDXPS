...
/**
 ** import javax.swing.JOptionPane; import java.awt.event.KeyEvent; import
...
public class Home extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		SelectVendedor.setModel(new javax.swing.AbstractListModel<String>() {
			...
			private VendedoresBD Vendedoreslist = new VendedoresBD();
			private ArrayList<Vendedor> list = Vendedoreslist.List();
	...
	private void EditVendedorActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_EditVendedorActionPerformed
		CadastroVendedor PEV = new CadastroVendedor(Vendedores.get(IndexVend));
		PEV.setVisible(true);
		setVisible(false);
		
		System.out.println("index"+IndexVend);
	}

	private void EditClientActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_EditClientActionPerformed
		CadastroCliente PEC = new CadastroCliente();
		PEC.setVisible(true);
	...
	private void SelectVendedorValueChanged(javax.swing.event.ListSelectionEvent evt) {
		...
		//System.out.println("listvalue" + SelectVendedor.getSelectedValue()+"index"+SelectVendedor.getSelectedIndex());
	}

	private void SelectClientValueChanged(javax.swing.event.ListSelectionEvent evt) {
		EditClient.setEnabled(true);
		System.out.println("listvalue" + SelectClient.getSelectedValue());
	}
